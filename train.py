...
for i,c in enumerate(faculty): 
    ...
    resL = [c+" can be found in the "+location[i],c+", "+designation[i]+", works in the "+location[i]]
...
for i,c in enumerate(faculty): 
    ...
    #creating the patterns
    fac=[c,"Who is "+c,"What does "+c+" do?","In which department does "+c+" work for?"]
    # fac.append(c)
    # fac.append("where can I find "+c)
    # fac.append("where will "+c+" be")
    # fac.append("where is the cabin of "+c)
